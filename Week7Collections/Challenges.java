...
public class Challenges {
    ...
    public static void main(String[] args) {
        ...
        // Next create a second set and populate it with ONLY the weekend days (SATURDAY and SUNDAY). Lastly,
        // compare the two sets and retain in the first set only those days that are the same in both sets.
